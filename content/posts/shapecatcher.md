...
**Note**: Shapes Catcher currently runs in legacy single-machine mode and has not yet been migrated to the networked dedicated server architecture. The Air Hockey game serves as the reference implementation for networked gameplay.
